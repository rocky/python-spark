...
if PYTHON3:
    ...
    from spark_parser import DEFAULT_DEBUG
    from spark_parser import GenericParser as GenericParser
    from spark_parser import GenericASTBuilder as GenericASTBuilder
    from spark_parser import GenericASTTraversalPruningException as GenericASTTraversalPruningException
    from spark_parser import GenericASTTraversal as GenericASTTraversal
